 ...
 * }
 * 
 * public void insertUpdateAlgorithm(MapState<String, TableLogger>
 * allTableState, Update updateTuple,
 * Collector<List<Tuple4<String, String, Integer, Double>>> collector) throws
 * Exception {
 ...
 * if (tupleTable.isRoot && (tupleTable.sCounter.get(updateTuple.primaryKey) ==
 * tupleTable.numChild)) {
 * // Perform Join
 ...
 * HashMap<Long, ArrayList<Long>> IRpAndR =
 * parentTable.indexTableAndTableChildInfo.get(tupleTable.tableName);
 * if (IRpAndR != null) {
